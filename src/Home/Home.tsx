      ...
      <article className="flex flex-col lg:flex-row lg:flex-row-reverse	lg:justify-end lg:items-center lg:px-10">
        <div className="lg:text-xl 2xl:text-xl">
          <section className="mb-4 lg:mb-8">
            <h1 className="text-2xl font-extrabold lg:text-5xl my-10">
              Human Tools
            </h1>
            ...
            <div className="my-10 flex flex-wrap">
              <ToolsNav
                showHome={false}
                className="font-light inline-flex w-60 h-20 items-center justify-center text-xs p-10 shadow text-center lg:text-xl lg:p-2 lg:m-2 hover:bg-gray-100"
                activeClassName=""
              />
            </div>
          </section>
